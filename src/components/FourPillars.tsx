          ...
          {activeTab === 'ux-data' && (
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
              ...
              <div className="lg:col-span-4 bg-white/[0.02] border border-white/10 p-6 rounded-2xl text-center">
                <Award className="w-12 h-12 text-[#FF1E42] mx-auto mb-3" />
                <h4 className="font-bold text-white text-lg">Google Double Professional</h4>
                <p className="text-xs text-slate-400 mt-2">Certificación Dual Oficial en UX Design y Análisis de Datos.</p>
              </div>
            </div>
          )}
        </div>
